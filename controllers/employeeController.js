                    ...
                    () => {
                        ...
                        if (req.files.import) {
                            APP.cdn
                                .uploadCDN(
                                    req.files.import,
                                    importPath + fileName + path.extname(req.files.import.name)
                                )
                                .then(res => {
                                    if (res.error == true) {
                                        callback({
                                        ...
                                        // replace path '\' with '/'
                                        callback(null, './' + req.files.import.tempFilePath.replace(/\\/g, '/'));
                                    }
                                });
                        }
                    },
                    ...
                    Promise.all(
                        dataObj.map((x, index) => {
                            ...
                            return employeeCode.then(code => {
                                let obj = {
                                    no: APP.validation.checkCSV(x.No),
                                    ...
                                    company_code: req.user.code,
                                    user_name:
                                        code.replace(req.user.code + '-', '') +
                                        '_' +
                                        x.Name.split(' ')[0].toLowerCase(),
                ...
                Promise.all(
                    ...
                    .then(arr => {
                        ...
                        if (filtered.length > 0) {
                            callback({
                                code: 'DUPLICATE',
                                message: `Error! Duplicate Email! Row no. ${filtered}`
                            });
                        } else {
                            callback(null, result);
                        }
                ...
                Promise.all(
                    ...
                    .then(arr => {
                        ...
                        if (filtered.length > 0) {
                            callback({
                                code: 'DUPLICATE',
                                message: `Error! Duplicate Telp! Row no. ${filtered}`
                            });
                        } else {
                            callback(null, result);
                        }
        ...
        [
                ...
                trycatch(
                    () => {
                        if (result.upload) {
                            ...
                            APP.fileCheck(req.files.contract_upload.tempFilePath, 'doc').then(res => {
                                if (res == null) {
                                    callback({
                                        code: 'INVALID_REQUEST',
            ...
            function uploadProcess(result, callback) {
                try {
                    // upload file
                    if (result.upload) {
                        APP.cdn.uploadCDN(req.files.contract_upload, result.contract).then(res => {
                            if (res.error == true) {
                                callback({
                                    code: 'ERR',
                                    data: res.data
                    ...
                    .then(res => {
                        if (res == null) {
                            ...
                            if (result.grade_id == grade_id) {
                                ...
                                APP.fileCheck(req.files.grade_upload.tempFilePath, 'doc').then(check => {
                    ...
                    .then(res => {
                        if (res == null) {
                            ...
                            if (result.data.department_id == department_id) {
                                ...
                                APP.fileCheck(req.files.department_upload.tempFilePath, 'doc').then(check => {
                                    if (check == null) {
                                        callback({
                                            code: 'INVALID_REQUEST',
                    ...
                    .then(res => {
                        if (res == null) {
                            ...
                            if (result.data.job_title_id == job_id) {
                                ...
                                APP.fileCheck(req.files.job_upload.tempFilePath, 'doc').then(check => {
                                    if (check == null) {
                                        callback({
                                            code: 'INVALID_REQUEST',
            ...
            function uploadProcess(result, callback) {
                try {
                    ...
                    if (result.status.grade) {
                        APP.cdn.uploadCDN(req.files.grade_upload, result.upload.grade).then(res => {
                            if (res.error == true) {
                                return callback({
                                    code: 'ERR',
                                    data: res.data
                    ...
                    if (result.status.department) {
                        APP.cdn.uploadCDN(req.files.department_upload, result.upload.department).then(res => {
                            if (res.error == true) {
                                return callback({
                                    code: 'ERR',
                                    data: res.data
                    ...
                    if (result.status.job) {
                        APP.cdn.uploadCDN(req.files.job_upload, result.upload.job).then(res => {
                            if (res.error == true) {
                                return callback({
                                    code: 'ERR',
                                    data: res.data
            ...
            function uploadPath(result, callback) {
                trycatch(
                    () => {
                        ...
                        APP.fileCheck(req.files.doc_upload.tempFilePath, 'doc').then(res => {
                            if (res == null) {
                                callback({
                                    code: 'INVALID_REQUEST',
                                    message: 'File yang diunggah tidak sesuai!'
            ...
            function uploadProcess(result, callback) {
                try {
                    ...
                    if (req.files.doc_upload) {
                        APP.cdn.uploadCDN(req.files.doc_upload, result.doc).then(res => {
                            if (res.error == true) {
                                callback({
                                    code: 'ERR',
                                    data: res.data
