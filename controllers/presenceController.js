                              ...
                              .then(resSwitch => {
                                if (resSwitch.length == 0) {
                                  ...
                                  presence
                                    ...
                                    .then(updatedSwitch => {
                                      console.log('Hasil LD Switch', updatedSwitch);
                                    });
                                }
                              });
                          }
    ...
    [
      ...
      function uploadPath(result, callback) {
        try {
          ...
          if (result.type == 'checkin') fileName = `${moment().format('YYMMDD')}_checkin_image_`;
          else fileName = `${moment().format('YYMMDD')}_checkout_image_`;
          ...
          Promise.all(
            images.map((x, i) => {
              return APP.cdn.writeFileCDN(x, dir + `${fileName}${i + 1}.jpg`).then(res => {
                if (res.error == true) {
