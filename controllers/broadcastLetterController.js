    ...
    async.waterfall(
        [
            ...
            function sendMail(data, callback) {
                try {
                    console.log(process.env.CDN_HOST + data.path.slice(8));
                    APP.mailer.sendMail({
                        ...
                        attachments: [
                            {
                                ...
                                path: process.env.CDN_HOST + data.path.slice(8) // slice 8 buat hilangin /public
                            }
                        ],
                        ...
                        if (res == null) {
                            ...
                            if (
                                ...
                                moment(res.created_at).format('YYYY-MM-DD') ==
                                    moment(req.currentDate.getTime()).format('YYYY-MM-DD')
                            ) {
                                callback({
                                    code: 'INVALID_REQUEST',
                                    id: '?',
                        ...
                        attachments: [
                            {
                                ...
                                path: process.env.CDN_HOST + data.broadcast.upload
                            }
                        ],
                        file: 'broadcast_letter.html'
                    });
