                    ...
                    .findAll({
                        include: [
                            ...
                            },
                            {
                                ...
                                attributes: ['id', 'name', 'description'],
                                where: {
                                    user_level: { $in: [req.user.level, 0, 5, 4] }
                                }
                            }
                        ],
                        where: {
                ...
                endpoint
                    ...
                    .catch(err => {
                        ...
                        callback({
                            ...
                            no: 'CMQ98',
                            message:
                                'Database bermasalah, mohon coba kembali atau hubungi tim operasional kami ( endpoint )',
                            data: err
                        });
                    });
            },
                ...
                subfeature
                    ...
                    .catch(err => {
                        ...
                        callback({
                            ...
                            no: 'CMQ98',
                            message:
                                'Database bermasalah, mohon coba kembali atau hubungi tim operasional kami ( sub feature )',
                            data: err
                        });
                    });
            },
