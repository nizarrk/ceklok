...
app.use(
    fileUpload({
        // tinggal di uncomment kalau mau terusin progess pisah cdn
        // useTempFiles : true,
                ...
                app.use(endpoint, (req, res, next) => {
                    if (req.headers.authorization) {
                        ...
                        if (routes[endpoint].level == 4) {
                            ...
                            routes[endpoint].level == 1 ||
                            routes[endpoint].level == 2 ||
                            routes[endpoint].level == 3
                        ) {
                            console.log('masuk level 1 2 3');
